<div class="wrap about-wrap">
    <h1>WordPress Pages Menu Videos</h1>

    <div class="about-text">
        <p>The following videos are instructional for the Pages menu. Thanks again to <a href="http://wordpress.tv" target="_blank">wordpress.tv</a> for the videos.</p>
    </div>

    <div class="allvideos">
        <h2>Pages</h2>
        <div class="video">
            <iframe width="560" height="315" src="https://videopress.com/embed/h3laSRim" frameborder="0" allowfullscreen></iframe>
